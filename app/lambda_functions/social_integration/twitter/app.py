"""
    This function will share content to the Twitter profile.
"""
...
from publish import PublishTwitter
...
def main(event, context):
    """ Lambda Handler for Twitter content publish """
    ...
    if(twitter):
        ...
        payload = twitter.get_payload_from_event(parsed_event)
        log.debug(f'Payload: {payload}')

    if(payload):
        # Share content to Twitter.
        twitter.post_content(payload)
